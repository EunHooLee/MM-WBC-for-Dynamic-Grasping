...
class MujocoFetchPickAndPlaceEnv(MujocoFetchEnv, EzPickle):
    ...
    | --- | ------------------------------------------------------ | ----------- | ----------- | --------------------------------------------------------------- | ----- | ------------ |
    | 0   | Displacement of the end effector in the x direction dx | -1          | 1           | robot0_gripper:mocap                                            | hinge | position (m) |
    | 1   | Displacement of the end effector in the y direction dy | -1          | 1           | robot0_gripper:mocap                                            | hinge | position (m) |
    | 2   | Displacement of the end effector in the z direction dz | -1          | 1           | robot0_gripper:mocap                                            | hinge | position (m) |
    | 3   | Positional displacement per timestep ... the gripper   | -1          | 1           | robot0:r_gripper_finger_joint and robot0:l_gripper_finger_joint | hinge | position (m) |
    | 4   | Displacement of the robot in the x                                                 | robot0_base:mocap
    | 5   | Displacement of the robot in the y                                                 |

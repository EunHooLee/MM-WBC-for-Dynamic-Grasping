...
# from gymnasium_robotics.envs.fetch_env import MujocoPandaEnv, MujocoPyPandaEnv
...
class MujocoPyPandaPushEnv(MujocoPyPandaEnv, EzPickle):
...
class MujocoPandaPushEnv(MujocoPandaEnv, EzPickle):
    """
    ## Description
